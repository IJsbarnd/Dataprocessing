# Repository of Dataprocessing course WC02 #
...
The `-c1` command here expresses the amount of cores, this is a required argument or the pipeline will not run. The amount of cores does not have to be one.
